...
public class ChessFive2 extends Panel implements MouseListener//,ActionListener
{
	...
	ChessFive2() throws Exception
	{
		...
		bClientStart.addActionListener(new ActionListener() 
				{
	...
	public void mousePressed(MouseEvent e)
	{
		...
		if (a > 0 && a <= 15 && b > 0 && b <= 15 && chess[a - 1][b - 1] == 0)
		{
			...
			{
				chess[a - 1][b - 1] = 1;
				try{dataout.writeUTF("chess" + ":" + a  +":" + b +":"+ "1" + ":" +  ")\n");}catch(Exception e1){}
				t1.append("红方棋子位置:(" + a + "," + b + ")\n");
				ChessChange.ibool=true;
			}
			if (win(a - 1, b - 1) == 1)
			{
				System.out.println("恭喜,红方胜!!");
				t1.append("恭喜,红方胜!!\n");
				bWin=0;
...
{
	ChessFive2 p;
	Test2(String s)throws Exception
	{
		super(s);
		p = new ChessFive2();
